...
<script>
export default {
    //The props state that it expects a property named id and the router gives the property value from the url
    //We also need to add give the value of props to true in the routes for this to work
    props: ['id'],
    computed: {
        meetup () {
